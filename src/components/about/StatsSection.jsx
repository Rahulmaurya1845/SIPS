...
// --- SHARED VIEWPORT REF FOR SYNCHRONIZED ANIMATION ---
const useSharedInView = () => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  return { ref, isInView };
};

// --- SYNCHRONIZED ANIMATED COUNTER ---
const AnimatedCounter = ({ value, suffix = "", isInView }) => {
  ...
  const spring = useSpring(0, { 
    ...
    stiffness: 40, 
    damping: 15,
    duration: 2 // Consistent duration for all
  });
...
const StatsSection = () => {
  const { ref: sectionRef, isInView } = useSharedInView();

  return (
    <section 
      ref={sectionRef}
      className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          >
            For over five years, we have been shaping young minds with dedication, 
