  ...
  return (
    <section ref={sectionRef} className="py-28 bg-gradient-to-br from-slate-50 via-white to-slate-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-6 px-8 py-4 rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-200/30">
            ...
            <div className="text-left">
              <div className="text-sm font-bold text-slate-900">Join 2000+ Parents</div>
              <div className="text-xs text-slate-500">Who trust us with their children</div>
            </div>
            <div className="h-8 w-px bg-slate-200" />
            <button className="px-6 py-2.5 rounded-full bg-slate-900 text-white text-sm font-semibold hover:bg-slate-800 transition-colors">
              Enquire Now
            </button>
          </div>
        </motion.div>
