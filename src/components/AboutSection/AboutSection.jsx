        ...
        <div className="relative w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center min-h-[calc(100vh-8rem)]">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1 pt-8 lg:pt-0">
              ...
              {/* Trust Indicators - 1000+ STUDENTS */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-6 sm:mt-8 pt-6 border-t border-slate-200/60">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-slate-500 font-medium">1000+ Students</span>
                </div>
            ...
            {/* RIGHT CONTENT - PREMIUM IMAGE SECTION (NO DIALOG BOX) */}
            <div className="relative order-1 lg:order-2 flex flex-col items-center lg:items-end">
              ...
              <div className="relative w-full max-w-lg lg:max-w-none lg:w-full">
                ...
                <div className="absolute -inset-4 bg-gradient-to-r from-amber-200/50 via-orange-200/50 to-rose-200/50 rounded-3xl blur-2xl animate-pulse"></div>
                
                {/* Premium Image Wrapper */}
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-slate-300/50 border-[6px] border-white">
                  <img
                    src={img1}
                    alt="School staff with honorable Director Mr. Shebin Abraham Sir"
                    className="w-full h-[380px] sm:h-[480px] lg:h-[580px] object-cover transform hover:scale-105 transition-transform duration-700"
                  />
                  ...
                  {/* ================= PREMIUM NAME SECTION - NO BOX ================= */}
                  <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8 lg:p-10">
                    {/* Elegant Top Border Line */}
                    <div className="w-20 h-1 bg-gradient-to-r from-amber-400 to-orange-500 mb-4 sm:mb-5"></div>
                    
                    {/* Label with Crown Icon */}
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <Crown className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400" />
                      <span className="text-amber-300 text-xs sm:text-sm font-bold uppercase tracking-[0.2em]">
                        School Staff with Honorable
                      </span>
                    </div>
                    
                    {/* Premium Name - Large & Elegant with Gradient */}
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black leading-tight mb-2 sm:mb-3">
                      <span className="bg-gradient-to-r from-white via-amber-100 to-amber-200 bg-clip-text text-transparent drop-shadow-2xl">
                        Mr. Shebin Abraham Sir
                      </span>
                    </h2>
                    
                    {/* Title with Excellence Badge */}
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                      <span className="text-white/90 text-sm sm:text-base lg:text-lg font-semibold">
                        Director & Visionary Leader
                      </span>
                      <span className="px-2 py-0.5 rounded-full bg-amber-500/20 border border-amber-400/30 text-amber-300 text-[10px] sm:text-xs font-bold uppercase tracking-wider">
                        Excellence
                      </span>
                    </div>
                    
                    {/* Premium Stars Row with Separator */}
                    <div className="flex items-center gap-3 mt-4 sm:mt-5 pt-4 sm:pt-5 border-t border-white/10">
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-5 h-5 sm:w-6 sm:h-6 text-amber-400 fill-amber-400 drop-shadow-lg" />
                        ))}
                      </div>
                      <div className="h-4 w-px bg-white/20"></div>
                      <span className="text-white/70 text-xs sm:text-sm font-medium">Excellence in Education</span>
                  ...
                  <div className="absolute top-4 left-4 sm:top-6 sm:left-6">
                    <div className="bg-white/95 backdrop-blur-md rounded-xl px-3 py-2 sm:px-4 sm:py-3 shadow-xl border border-white/50 flex items-center gap-2">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-lg">
                  ...
                  <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
                    <div className="bg-white/95 backdrop-blur-md rounded-xl px-3 py-2 sm:px-4 sm:py-3 shadow-xl border border-white/50 flex items-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm font-bold text-slate-700">India</span>
                    </div>
                  </div>

                  {/* Corner Accents */}
                  <div className="absolute top-0 left-0 w-24 h-24 bg-gradient-to-br from-amber-400/20 to-transparent"></div>
                  <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl from-orange-500/10 to-transparent"></div>
                </div>

                {/* NO QUOTE CARD / DIALOG BOX - COMPLETELY REMOVED */}
